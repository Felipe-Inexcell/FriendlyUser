...
public class Calidad2 extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calidad2);
        activity = this;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.ib_back:
                ...
                break;
            case R.id.ib_send:
                startActivity(new Intent(this, Calidad3.class));
                break;
        }
    }
